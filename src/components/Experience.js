				...
				<div className="container relative">
					<div className="row">
						...
						<div className="col-md-9 col-sm-8">
							...
							<div className="row">
									<div className="col-md-3 black">Feb 19 &ndash; Present</div>
									<div className="col-md-9">
										<h4 className="mt-0">
											Texas A&M University
		                    </h4>
		                    Build and maintained a single page application for TAMU Marketing that streamlined the marketing efforts to 100+ thousand potential students. 
							Tech stack includes:KenticoCMS, Javascript, Angular, jQuery, SASS, .NET, NuGet, Microsoft Visual Studio, Liquid Markup, SiteImprove, Slate, C#, and K#.
								...
								<hr />
								<div className="row">
									<div className="col-md-3 black">Feb 18 &ndash; June 19</div>
									<div className="col-md-9">
										<h4 className="mt-0">
											Katie Bush Designs
		                    </h4>
